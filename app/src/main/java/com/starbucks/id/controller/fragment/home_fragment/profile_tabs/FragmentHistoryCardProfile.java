...
public class FragmentHistoryCardProfile extends Fragment implements CardAdapter.ItemClickListener,
    ...
    public FragmentHistoryCardProfile() {
    ...
    private void setBaseView() {
        activity.setToolbarTitle(
                userDefault.IDLanguage()
                        ? activity.getString(R.string.id_activity_history_title)
                        : activity.getString(R.string.en_activity_history_title));

        CLContainer.setVisibility(View.VISIBLE);
        time = timePick.get(0);
        if (userDefault.IDLanguage()) tvEmpty.setText(activity.getString(R.string.id_empty_activity));
    ...
    private void getTrx() {
        ...
        Call<ActivityResponseModel> callTrx = apiService.getTrx("get_activity_transaction_star",
