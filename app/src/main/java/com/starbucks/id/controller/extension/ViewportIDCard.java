...
public class ViewportIDCard extends ViewGroup {

    public ViewportIDCard(Context context) {
        super(context);
    }

    public ViewportIDCard(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ViewportIDCard(Context context, AttributeSet attrs, int defStyle) {
